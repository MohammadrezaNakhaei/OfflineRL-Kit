...
class NSequenceBuffer(IterableDataset):
    ...
    def _prepare_sample(self, traj_id:int):
        ...
        return seq_states, seq_actions, seq_masks, state, action, reward, done
        # return dict(
        #     seq_states=seq_states, seq_actions=seq_actions, 
        #     seq_masks=seq_masks, state=state, action=action, 
