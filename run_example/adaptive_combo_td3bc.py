...
def train(mainargs=get_args(), delta_m=1):
    ...
    # log
    log_dirs = make_log_dirs(f'{args.task}-adaptive', f'{args.algo_name}_td3bc', mainargs.seed, vars(mainargs), record_params=['tag'])
