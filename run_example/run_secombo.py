...
from offlinerlkit.modules import ActorProb, Critic, TanhDiagGaussian, GPTDynamicsModel
...
from offlinerlkit.policy import SECOMBOPolicy


def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--algo-name", type=str, default="secombo")
    ...
    parser.add_argument("--dynamics-hidden-dims", type=int, default=512)
...
def train(args=get_args()):
    ...
    dynamics_model = GPTDynamicsModel(
        obs_dim=np.prod(args.obs_shape),
        action_dim=args.action_dim,
        seq_len=args.seq_len,
        embedding_dim=args.embedding_dim,
        hidden_dim=args.dynamics_hidden_dims,
